...
public class PrincipalConBusquedaApi {
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        while (true){
            ...
            System.out.println("Escriba el nombre de una pelicula o escriba" + " salir, para salir del programa");
            ...
            try {
                ...
                System.out.println("Error en la URI, verifiquie la direccion");
